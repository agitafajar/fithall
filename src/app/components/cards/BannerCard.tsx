...
const BannerCard: React.FC<BannerCardProps> = ({ icon, title }) => {
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center sm:h-[250px] md:h-[330px] lg:h-[330px] xl:h-[330px] sm:mt-5 sm:mb-5 md:mb-12">
        <div
        ...
        >
          <div className="flex flex-col justify-center items-center relative z-10">
            ...
            <p className="font-bold sm:text-3xl md:text-4xl text-white mb-6 capitalize">
              {title}
            </p>
          </div>
