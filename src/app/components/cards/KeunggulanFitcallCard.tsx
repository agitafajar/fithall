  ...
  return (
    <div className="mb-12">
      ...
      <div className="grid grid-cols-4 text-center gap-6">
        ...
        <div className="p-4 flex flex-col gap-6 px-8 rounded-xl justify-center items-center border-2">
          <img src="../assets/png/keunggulan2.png" className="ml-1 pt-1" />
          <p className="font-bold text-xl">Fasilitas Pilihan</p>
          <p className="text-[##323F4B]">
            Nikmati Keunggulan Booking dengan Fasilitas Sesuai Pilihanmu
          </p>
        ...
        <div className="p-4 flex flex-col gap-6 px-8 rounded-xl justify-center items-center border-2">
          <img src="../assets/png/keunggulan3.png" className="ml-1 pt-1" />
          <p className="font-bold text-xl">Fasilitas Pilihan</p>
          <p className="text-[##323F4B]">
            Nikmati Keunggulan Booking dengan Fasilitas Sesuai Pilihanmu
          </p>
        ...
        <div className="p-4 flex flex-col gap-6 px-8 rounded-xl justify-center items-center border-2">
          <img src="../assets/png/keunggulan4.png" className="ml-1 pt-1" />
          <p className="font-bold text-xl">Fasilitas Pilihan</p>
          <p className="text-[##323F4B]">
            Nikmati Keunggulan Booking dengan Fasilitas Sesuai Pilihanmu
          </p>
